...
import com.boreebeko.forum_service.service.QuestionService;
...
public class QuestionController {
    ...
    @Cacheable("questions")
    public ResponseEntity<List<QuestionDTO>> getQuestions(@RequestParam(defaultValue = "0") int page) {
        List<QuestionDTO> response = questionService.getQuestions(page);
